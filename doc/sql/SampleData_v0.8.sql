...
insert into oi_product(pno, title, content, stock, price, discount, photo) value (7, '오이고추', '맛있어요', 100, 3000, 0, 'g.jpeg');
insert into oi_product(pno, title, content, stock, price, discount, photo) value (8, '할라피뇨', '맛있어요', 111, 5000, 0, 'h.jpeg');
insert into oi_product(pno, title, content, stock, price, discount, photo) value (9, '브라질닭', '맛있어요', 30, 2700, 0, 'i.jpeg');
insert into oi_product(pno, title, content, stock, price, discount, photo) value (10, '평창한우', '맛있어요', 10, 45000, 0, 'j.jpeg');

-- 회원 
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (1, 'sejunO854', 'sj', 'sj@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 1);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (2, 'eunchae-Cho', 'ec', 'ec@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (3, 'aramYu', 'ar', 'ar@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (4, 'seunghyuck', 'sh', 'sh@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (5, 'dragonmin', 'ym', 'ym@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (6, 'somi-Shin', 'sm', 'sm@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (7, 'jinyoungChoi', 'jy', 'jy@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (8, 'Test01', 't1', 't1@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (9, 'EomTeacher', 'et', 'et@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (10, 'Test02', 't2', 't2@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (11, 'Test03', 't3', 't3@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values (12, 'youngjinEom', 'yj', 'yj@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 0);
insert into oi_user(uno, name, nick, email, password, point, photo, utype) values(13,'테스트', '테스트', 'test@test.com', password(1111), 0, '67852bd8-9a5a-448a-a411-6e3c46b760a8', 1);
