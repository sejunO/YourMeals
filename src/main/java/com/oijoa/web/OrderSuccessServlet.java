...
public class OrderSuccessServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      request.getRequestDispatcher("/order/success.jsp").include(request, response);
    } catch (Exception e) {
...
// out.println("<thead><tr>" + "<th>주문항목</th>" + "<th>결제정보</th>" + "<th>주문일</th>" + "<th>주소</th>"
// + "<th>상세주소</th>" + "<th>메모</th>" + "<th>배송</th>" + "<th>운송장번호</th>" + "<th>장바구니 정보</th>"
// + "</tr></thead>");
// out.println("<tbody>");
//
