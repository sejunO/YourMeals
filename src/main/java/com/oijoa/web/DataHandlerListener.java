...
public class DataHandlerListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    try {
      ...
      //      DeleveryCompanyDao deleveryCompanyDao = new DeleveryCompanyDaoImpl(sqlSessionFactory);
      //      FollowDao followDao = new followDaoDaoImpl(sqlSessionFactory);
      ...
      //      DeleveryCompanyService deleveryCompanyService = new DefaultDeleveryCompanyService(deleveryCompanyDao);
      ...
      //      ctx.setAttribute("deleveryCompanyService", deleveryCompanyService);
