...
<aside class="bd-aside sticky-xl-top text-muted align-self-start mb-3 mb-xl-5 px-2">
  ...
  <nav class="small" id="toc">
    <ul class="list-unstyled">
      <li class="my-2">
        <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse">Follow</button>
        <ul class="list-unstyled ps-3 collapse" id="contents-collapse">
          <li><a class="d-inline-flex align-items-center rounded" href="#images">Images</a></li>
          <li><a class="d-inline-flex align-items-center rounded" href="#follower">Follower</a></li>
          <li><a class="d-inline-flex align-items-center rounded" href="#following">Following</a></li>
          <li><a class="d-inline-flex align-items-center rounded" href="#figures">Figures</a></li>
        </ul>
      </li>
            <li class="my-2">
        <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse">qna</button>
        <ul class="list-unstyled ps-3 collapse" id="contents-collapse">
          <li><a class="d-inline-flex align-items-center rounded" href="#qna">qna</a></li>
        </ul>
      </li>
      <li class="my-2">
  ...
  <section id="content">
    ...
    <article class="my-3" id="images">
      ...
      <div>
        ...
        <jsp:include page="/mypage/follow/follower/newlist.jsp"></jsp:include>
        <jsp:include page="/mypage/follow/following/newlist.jsp"></jsp:include>
...
<section id="qna">
<h2 class="sticky-xl-top fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">qna</h2>
<jsp:include page="/mypage/qna/newlist.jsp"></jsp:include>
</section>
  <section id="forms">
