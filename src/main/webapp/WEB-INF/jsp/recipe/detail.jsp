...
<link
            ...
            <div class="recipe-content" id="img-recipe" data-aos="fade-right" data-aos-delay="100">
              <div class="side-and-side">
                ...
                <div id="right">
                  ...
                  <c:if test='${recipe.modifiedDate != null}'>
                    <h5>${recipe.createdDate} (최종 수정일:${recipe.modifiedDate})</h5>
                    <h5>${recipe.category.categoryName}</h5>
                  </c:if>
                </div>
              </div>
              <h2>${recipe.title}</h2>
              <img src="../../upload/${recipe.photo}_1280x720.jpg" class="img-thumbnail" alt="..."><br>
            </div>
 ...
 <hr>
        ...
        <div class="container-marterial">
          <div class="row">
            ...
            <div id="commentContent">
              <input type="text" class="form-control" name="content" id="content" placeholder="메세지를 입력하세요"
        ...
        <div class="container">
          ...
          <p>
            New to Bootstrap? <a href="https://getbootstrap.com/">Visit the
              homepage</a> or read our <a href="/docs/4.5/getting-started/introduction/">getting started
              guide</a>.
          </p>
        </div>
      </footer>
      ...
      <script src="<%=request.getContextPath()%>/node_modules/dist/js/bootstrap.bundle.min.js"
